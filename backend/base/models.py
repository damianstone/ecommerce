...
# en models.py se creanm las tablas que van a la base de datos
# el comando migrate es para crear estas tablas en la base de datos

# class => the big object in the database
